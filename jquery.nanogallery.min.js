...
Math.max(f.scale,1.5);break;case "scale120":f.scale=Math.max(f.scale,1.2)}"auto"==u()?(ha=Math.ceil(m()*f.scale),L.thumbSizeDir="width_"):"auto"==m()?ha=Math.ceil(u()*f.scale):m()>u()?(ha=Math.ceil(m()*f.scale),L.thumbSizeDir="width_"):ha=Math.ceil(u()*f.scale);switch(g.kind){case "":U(R.breadcrumbHome,"","","","","album","","0","-1");0<g.itemsBaseURL.length&&(g.itemsBaseURL+="/");void 0!==g.items&&null!==g.items?(Tb(),r(!1)||X(0,!1)):(a=jQuery(d.base).children("a"),0<a.length?(Ub(a),r(!1)||X(0,!1)):
V("error: no image to process."));break;case "flickr":g.flickrSkipOriginal||(L.photoAvailableSizes.push(1E4),L.photoAvailableSizesStr.push("o"));for(i=0;i<L.photoAvailableSizes.length&&!(L.photoSize=i,a<=L.photoAvailableSizes[i]);i++);U(R.breadcrumbHome,"","","","","album","",0<g.photoset.length?g.photoset:"0","-1");yb(0,!0,-1,!1);break;case "smugmug":V("SMUGMUG IS NO MORE SUPPORTED BY NANOGALLERY.");for(i=0;i<Q.photoAvailableSizes.length&&!(Q.thumbSize=i,ha<=Q.photoAvailableSizes[i]);i++);for(i=
0;i<Q.photoAvailableSizes.length&&!(Q.thumbSizeX2=i,2*ha<=Q.photoAvailableSizes[i]);i++);for(i=0;i<Q.photoAvailableSizes.length&&!(Q.photoSize=i,a<=Q.photoAvailableSizes[i]);i++);U(R.breadcrumbHome,"","","","","album","","0","-1");$a(0,!0,-1,!1);break;default:0<g.album.length?(c=g.album.indexOf("&authkey="),0<=c?(a=g.album.substring(0,c),c=g.album.substring(c),-1==c.indexOf("Gv1sRg")&&(c="&authkey=Gv1sRg"+c.substring(9)),U(R.breadcrumbHome,"","","","","album","",a,"-1").customData.authkey=c):U(R.breadcrumbHome,
"","","","","album","",g.album,"-1")):U(R.breadcrumbHome,"","","","","album","","0","-1"),zb(0,!0,-1,!1)}jQuery(document).keyup(function(b){if(Y)switch(b.keyCode){case 27:Aa(!0);break;case 32:case 13:ab();break;case 38:case 39:case 33:Ba();break;case 40:case 37:case 34:Ca()}});jQuery(window).bind("hashchange",function(b){g.locationHash&&r(!0)});g.galleryFullpageButton&&(d.conNavBFullpage=jQuery('<div class="nanoGalleryFullpage setFullPageButton"></div>').appendTo(d.conNavB),d.conNavBFullpage.on("click",
...
0;Z=la=null;jQuery(d.conTn[0]).css({left:0});if(Y)aa=null,ma=!1;else if(null!=aa)if(10<Math.abs(k.t-P().t))aa=null,ma=!1;else{var b=aa,a=b.data("index");void 0!=a&&(g.touchAnimation&&!ma?0<g.touchAutoOpenDelay?(Ea(),bb(b),window.clearInterval(cb),cb=window.setInterval(function(){window.clearInterval(cb);10<Math.abs(k.t-P().t)?(ma=!1,aa=null,db(b)):eb(a)},g.touchAutoOpenDelay)):p[a].hovered?eb(a):(Ea(),bb(b)):eb(a))}else ma=!1}function b(b){var a={};b.targetTouches?(a.x=b.targetTouches[0].clientX,
a.y=b.targetTouches[0].clientY):(a.x=b.clientX,a.y=b.clientY);return a}function e(){if(s){if(0<T&&"auto"!=f.settings.height[G][H]&&"auto"!=f.settings.width[G][H]){var b=Da-(la.x-Z.x);jQuery(l).css({left:b})}s=!1}}var l=a,s=!1,la=null,Z=null,Da=0,h=!1,k=0;this.handleGestureStartNoDelay=function(b){Y||400>(new Date).getTime()-fb||(ma=!0,this.handleGestureStart(b))}.bind(this);this.handleGestureStart=function(a){if(!(Y||400>(new Date).getTime()-fb)){fb=(new Date).getTime();for(var c=a.target||a.srcElement,
...
!1):g.photoset="";void 0!==g.album?0<g.album.length&&(g.displayBreadcrumb=!1):g.album="";void 0!==g.gallery?0<g.gallery.length&&(g.displayBreadcrumb=!1):g.gallery="";0<g.maxWidth&&(jQuery(d.base).css({maxWidth:g.maxWidth}),jQuery(d.base).css({"margin-left":"auto"}),jQuery(d.base).css({"margin-right":"auto"}));"number"==S(g.slideshowDelay)&&2E3<=g.slideshowDelay?Ma=g.slideshowDelay:ia('Parameter "slideshowDelay" must be an integer >= 2000 ms.');"number"==S(g.thumbnailDisplayInterval)&&0<=g.thumbnailDisplayInterval?
f.displayInterval=g.thumbnailDisplayInterval:ia('Parameter "thumbnailDisplayInterval" must be an integer.');"number"==S(g.thumbnailLazyLoadTreshold)&&0<=g.thumbnailLazyLoadTreshold?f.lazyLoadTreshold=g.thumbnailLazyLoadTreshold:ia('Parameter "thumbnailLazyLoadTreshold" must be an integer.');"number"==S(g.paginationMaxLinesPerPage)&&0<=g.paginationMaxLinesPerPage?T=g.paginationMaxLinesPerPage:ia('Parameter "paginationMaxLinesPerPage" must be an integer.');var a=g.albumSorting.toUpperCase();0==a.indexOf("RANDOM")&&
6<a.length&&(n=parseInt(a.substring(6)),0<n&&(Na=n),g.albumSorting="random");a=g.photoSorting.toUpperCase();0==a.indexOf("RANDOM")&&6<a.length&&(n=parseInt(a.substring(6)),0<n&&(Oa=n),g.photoSorting="random");switch(S(g.thumbnailHoverEffect)){case "string":for(var c=g.thumbnailHoverEffect.split(","),a=0;a<c.length;a++)if("none"!=c[a]&&h(c[a])){var b=v();b.name=c[a];B.push(b)}break;case "object":"none"!=g.thumbnailHoverEffect.name&&h(g.thumbnailHoverEffect.name)&&(b=v(),B.push(jQuery.extend(b,g.thumbnailHoverEffect)));
break;case "array":for(a=0;a<g.thumbnailHoverEffect.length;a++)"none"!=g.thumbnailHoverEffect[a].name&&h(g.thumbnailHoverEffect[a].name)&&(b=v(),B.push(jQuery.extend(b,g.thumbnailHoverEffect[a])));break;case "null":break;default:V('incorrect parameter for "thumbnailHoverEffect".')}0==B.length&&(g.touchAnimation=!1);H=ba();if("number"==S(g.thumbnailWidth))k("width","l1",g.thumbnailWidth,"u"),k("width","lN",g.thumbnailWidth,"u");else{c=g.thumbnailWidth.split(" ");b="auto";"auto"!=c[0].substring(0,4)&&
(b=parseInt(c[0]));var e="u";"C"==c[0].charAt(c[0].length-1)&&(e="c");k("width","l1",b,e);k("width","lN",b,e);for(a=1;a<c.length;a++){var l=c[a].substring(0,2).toLowerCase();if(/xs|sm|me|la|xl/i.test(l)){var s=c[a].substring(2),b="auto";"auto"!=s.substring(0,4)&&(b=parseInt(s));e="u";"C"==s.charAt(s.length-1)&&(e="c");f.settings.width.l1[l]=b;f.settings.width.lN[l]=b;f.settings.width.l1[l+"c"]=e;f.settings.width.lN[l+"c"]=e}}}if(void 0!=g.thumbnailL1Width)if("number"==S(g.thumbnailL1Width))k("width",
"l1",g.thumbnailL1Width,"u");else for(c=g.thumbnailL1Width.split(" "),b="auto","auto"!=c[0].substring(0,4)&&(b=parseInt(c[0])),e="u","C"==c[0].charAt(c[0].length-1)&&(e="c"),k("width","l1",b,e),a=1;a<c.length;a++)l=c[a].substring(0,2).toLowerCase(),/xs|sm|me|la|xl/i.test(l)&&(s=c[a].substring(2),b="auto","auto"!=s.substring(0,4)&&(b=parseInt(s)),e="u","C"==s.charAt(s.length-1)&&(e="c"),f.settings.width.l1[l]=b,f.settings.width.l1[l+"c"]=e);if("number"==S(g.thumbnailHeight))k("height","l1",g.thumbnailHeight,
...
e,f.settings.height.lN[l+"c"]=e);if(void 0!=g.thumbnailL1Height)if("number"==S(g.thumbnailL1Height))k("height","l1",g.thumbnailL1Height,"u");else for(c=g.thumbnailL1Height.split(" "),b="auto","auto"!=c[0].substring(0,4)&&(b=parseInt(c[0])),e="u","C"==c[0].charAt(c[0].length-1)&&(e="c"),k("height","l1",b,e),a=1;a<c.length;a++)l=c[a].substring(0,2).toLowerCase(),/xs|sm|me|la|xl/i.test(l)&&(s=c[a].substring(2),b="auto","auto"!=s.substring(0,4)&&(b=parseInt(s)),e="u","C"==s.charAt(s.length-1)&&(e="c"),
f.settings.height.l1[l]=b,f.settings.height.l1[l+"c"]=e)}function k(a,c,b,e){f.settings[a][c].xs=b;f.settings[a][c].sm=b;f.settings[a][c].me=b;f.settings[a][c].la=b;f.settings[a][c].xl=b;f.settings[a][c].xsc=e;f.settings[a][c].smc=e;f.settings[a][c].mec=e;f.settings[a][c].lac=e;f.settings[a][c].xlc=e}function m(){return f.settings.width[G][H]}function u(){return f.settings.height[G][H]}function I(){return f.outerWidth[G][H]}function ea(){return f.outerHeight[G][H]}function ba(){var a=P().w;return 0<
g.thumbnailSizeSM&&a<g.thumbnailSizeSM?"xs":0<g.thumbnailSizeME&&a<g.thumbnailSizeME?"sm":0<g.thumbnailSizeLA&&a<g.thumbnailSizeLA?"me":0<g.thumbnailSizeXL&&a<g.thumbnailSizeXL?"la":"xl"}function v(){var a={delay:0,delayBack:0,duration:400,durationBack:200,easing:"swing",easingBack:"swing",animParam:null};"animate"!=D&&(a.easing="ease",a.easingBack="ease");return a}function h(a){var c=/labelOpacity50|borderLighter|borderDarker/i.test(a),b=/imageFlipVertical|imageFlipHorizontal|imageRotateCornerBR|imageRotateCornerBL|rotateCornerBL|rotateCornerBR|imageScale150|overScale|overScaleOutside|imageScaleIn80|imageScale150Outside|scale120|scaleLabelOverImage|slideUp|slideDown|slideLeft|slideRight|imageSlideUp|imageSlideDown|imageSlideLeft|imageSlideRight|labelAppear|labelAppear75|descriptionAppear|labelSlideDown|labelSlideUp|labelSlideUpTop|imageInvisible|imageOpacity50|descriptionSlideUp|labelSplitVert|labelSplit4|labelAppearSplitVert|labelAppearSplit4|imageSplitVert|imageSplit4/i.test(a),
...
a+'" requires one of the additionals jQuery plugins "Velocity" or "Transit".'),!1):(V('The parameter combination thumbnailHoverEffect="'+a+'" and thumbnailLabel.position="onBottom" is not supported.'),!1):(V('Unknow parameter value: thumbnailHoverEffect="'+a+'".'),!1)}function z(){fa=(navigator.language||navigator.userLanguage).toUpperCase();"UNDEFINED"===fa&&(fa="");var a=-("_"+fa).length;"object"==S(g.i18n)&&Object.keys(g.i18n).forEach(function(c){var b=c.substr(a);b=="_"+fa?R[c.substr(0,c.length-
b.length)]=g.i18n[c]:R[c]=g.i18n[c]})}function r(a){if(!g.locationHash)return!1;var c=null,b=null,c="#nanogallery/"+ga+"/",e=location.hash;if(e!=sa&&(""==e&&-1!=hb&&(sa="",ta(0,!1,-1,!1)),0==e.indexOf(c))){var l=e.substring(c.length),s=l.indexOf("/"),d=e=-1,Z=p.length;if(0<s)for(c=l.substring(0,s),b=l.substring(s+1),l=0;l<Z;l++){if("image"==p[l].kind&&p[l].GetID()==b){d=l;break}}else c=l;for(l=0;l<Z;l++)if("album"==p[l].kind&&p[l].GetID()==c){e=l;break}null!==b?(a||(Pa=e),""==g.kind?ua(d):-1==d?ta(e,
!1,b,a):ua(d)):ta(e,!1,-1,a);return!0}}function O(){p=[];var a="";g.thumbnailLabel.displayDescription&&(a="d");a=U("dummydummydummy","data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==","data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==",a,"","image","","1","0");a=Cb(a,0,0,!1);f.borderWidth=a.outerWidth(!0)-a.width();f.borderHeight=a.outerHeight(!0)-a.height();f.imgcBorderWidth=a.find(".imgContainer").outerWidth(!0)-
...
"auto"!=e?e+f.borderWidth+f.imgcBorderWidth:0;e=f.settings.width.lN[c[b]];f.outerWidth.lN[c[b]]="auto"!=e?e+f.borderWidth+f.imgcBorderWidth:0}for(b=0;b<c.length;b++)e=f.settings.height.l1[c[b]],f.outerHeight.l1[c[b]]="auto"!=e?e+f.borderHeight+f.imgcBorderHeight:0,e=f.settings.height.lN[c[b]],f.outerHeight.lN[c[b]]="auto"!=e?e+f.borderHeight+f.imgcBorderHeight:0;ja=ib();F.oldBorderColor=a.css("border-color");if(""==F.oldBorderColor||null==F.oldBorderColor||void 0==F.oldBorderColor)F.oldBorderColor=
"#000";F.oldLabelOpacity=a.find(".labelImage").css("opacity");a=jQuery.Color(a.find(".labelImage"),"backgroundColor");F.oldLabelRed=a.red();F.oldLabelGreen=a.green();F.oldLabelBlue=a.blue();p=[]}function Ga(a,c){var b="";return""!=fa&&void 0!==a[c+"_"+fa]&&0<a[c+"_"+fa].length?b=a[c+"_"+fa]:b=a[c]}function ca(a){return"%filename"==g.thumbnailLabel.title?a.split("/").pop().replace("_"," "):"%filenameNoExt"==g.thumbnailLabel.title?a.split("/").pop().split(".").shift().replace("_"," "):a}function Tb(){var a=
...
0<c.destURL.length&&(h=c.destURL);var p=Ga(c,"tags");void 0===p&&(p="");var k=0;void 0!==c.albumID&&(k=c.albumID,a=!0);var r=null;void 0!==c.ID&&(r=c.ID);var m="image";void 0!==c.kind&&0<c.kind.length&&(m=c.kind);e=U(e,s,l,f,h,m,p,r,k);e.thumbX2src=d;d=0;void 0!==c.thumbnailWidth&&0<c.imgtWidth&&(d=c.imgtWidth,e.thumbImgWidth=d);l=0;void 0!==c.thumbnailHeight&&0<c.imgtHeigt&&(l=c.imgtHeight,e.thumbImgHeight=l);e.thumbs={url:{l1:{xs:s,sm:s,me:s,la:s,xl:s},lN:{xs:s,sm:s,me:s,la:s,xl:s}},width:{l1:{xs:d,
sm:d,me:d,la:d,xl:d},lN:{xs:d,sm:d,me:d,la:d,xl:d}},height:{l1:{xs:l,sm:l,me:l,la:l,xl:l},lN:{xs:l,sm:l,me:l,la:l,xl:l}}};"function"==typeof g.fnProcessData&&g.fnProcessData(e,"api",null)});a&&(g.displayBreadcrumb=!0);for(var c=p.length,b=0,e=0,l=0;l<c;l++){for(var s=e=b=0;s<c;s++)l!=s&&p[l].GetID()==p[s].albumID&&(b++,"image"==p[s].kind&&(p[s].imageNumber=e++));p[l].contentLength=b}}function Ub(a){var c=!1;"undefined"!==typeof g.dataSorting&&("random"==g.dataSorting?a=na(a):"reversed"==g.dataSorting&&
...
(p=jQuery(a).attr("data-ngkind"));void 0!==jQuery(a).attr("data-ngKind")&&0<jQuery(a).attr("data-ngKind").length&&(p=jQuery(a).attr("data-ngKind"));var k=jQuery(a).text();""!=g.thumbnailLabel.title&&void 0!=g.thumbnailLabel.title&&(k=ca(src));s=U(k,e,src,s,d,p,"",h,f);s.thumbX2src=l;l=0;void 0!==jQuery(a).attr("data-ngthumbImgWidth")&&0<jQuery(a).attr("data-ngthumbImgWidth").length&&(l=jQuery(a).attr("data-ngthumbImgWidth"),s.thumbImgWidth=l);d=0;void 0!==jQuery(a).attr("data-ngthumbImgHeight")&&
...
l=0;l<a;l++){for(var s=e=b=0;s<a;s++)l!=s&&p[l].GetID()==p[s].albumID&&(b++,"image"==p[s].kind&&(p[s].imageNumber=e++));p[l].contentLength=b}}function yb(a,c,b,e){Qa(a);if(p[a].contentIsLoaded)X(a,e);else{var l="",s="album";0==p[a].GetID()?l=L.url()+"?&method=flickr.photosets.getList&api_key="+L.ApiKey+"&user_id="+g.userID+"&per_page=500&primary_photo_extras=url_o,url_sq,url_t,url_q,url_s,url_m,url_z,url_b,url_h,url_k&format=json&jsoncallback=?":(l="none"==p[a].GetID()?L.url()+"?&method=flickr.people.getPublicPhotos&api_key="+
L.ApiKey+"&user_id="+g.userID+"&extras=description,views,url_o,url_sq,url_t,url_q,url_s,url_m,url_z,url_b,url_h,url_k&per_page=500&format=json&jsoncallback=?":L.url()+"?&method=flickr.photosets.getPhotos&api_key="+L.ApiKey+"&photoset_id="+p[a].GetID()+"&extras=description,views,url_o,url_sq,url_t,url_q,url_s,url_m,url_z,url_b,url_h,url_k&format=json&jsoncallback=?",s="image");jb();jQuery.ajaxSetup({cache:!1});jQuery.support.cors=!0;jQuery.getJSON(l,function(l){oa();"album"==s?Wb(a,l):Xb(a,l);if(c)r(!1)||
X(a,e);else if(-1!=b){l=-1;for(var d=p.length,g=0;g<d;g++)if("image"==p[g].kind&&p[g].GetID()==b){l=g;break}ua(l,!0)}else X(a,e)}).fail(function(b,a,c){oa();V("Could not retrieve Flickr photoset list (jQuery): "+(a+", "+c))})}}function Wb(a,c){var b=!0;void 0!==c.stat&&"fail"===c.stat&&(V("Could not retrieve Flickr photoset list: "+c.message+" (code: "+c.code+")."),b=!1);if(b){var e=0,b=c.photosets.photoset;switch(g.albumSorting){case "random":b=na(b);break;case "reversed":b=b.reverse();break;case "titleAsc":b.sort(function(a,
...
g.thumbnailLabel.title&&(c=ca(p));c=U(c,"",p,f,"","image","",d,e);c.imageNumber=l;void 0!==a.url_o?(c.width=a.width_o,c.height=a.height_o):(c.width=a.width_z,c.height=a.height_z);c.thumbX2src=h;d={url:{l1:{xs:"",sm:"",me:"",la:"",xl:""},lN:{xs:"",sm:"",me:"",la:"",xl:""}},width:{l1:{xs:0,sm:0,me:0,la:0,xl:0},lN:{xs:0,sm:0,me:0,la:0,xl:0}},height:{l1:{xs:0,sm:0,me:0,la:0,xl:0},lN:{xs:0,sm:0,me:0,la:0,xl:0}}};d=Ra(d,a,"l1");d=Ra(d,a,"lN");c.thumbs=d;l++;if(l>=Oa)return!1});p[a].contentIsLoaded=!0;p[a].contentLength=
l}function da(a,c,b,e,l){var d=Math.ceil(b*f.scale)+l;"auto"==c?d=Math.ceil(b*f.scale)+l:"auto"==b?d=Math.ceil(c*f.scale)+e:c>b&&(d=Math.ceil(c*f.scale)+e);0<a.length&&(a+=",");return a+d}function zb(a,c,b,e){Qa(a);if(p[a].contentIsLoaded)X(a,e);else{var l="",d="album",l=da("",f.settings.width.l1.xs,f.settings.height.l1.xs,f.settings.width.l1.xsc,f.settings.height.l1.xsc),l=da(l,f.settings.width.l1.sm,f.settings.height.l1.sm,f.settings.width.l1.smc,f.settings.height.l1.smc),l=da(l,f.settings.width.l1.me,
...
f.settings.height.lN.me,f.settings.width.lN.mec,f.settings.height.lN.mec),l=da(l,f.settings.width.lN.la,f.settings.height.lN.la,f.settings.width.lN.lac,f.settings.height.lN.lac),l=da(l,f.settings.width.lN.xl,f.settings.height.lN.xl,f.settings.width.lN.xlc,f.settings.height.lN.xlc);if(0==p[a].GetID())l=Db.url()+"user/"+g.userID+"?alt=json&kind=album&imgmax=d&thumbsize="+l;else{var h="";"undefined"!==typeof p[a].customData.authkey&&(h=p[a].customData.authkey);l=Db.url()+"user/"+g.userID+"/albumid/"+
p[a].GetID()+"?alt=json&kind=photo"+h+"&thumbsize="+l+"&imgmax=d";d="image"}l+="&callback=?";jb();jQuery.ajaxSetup({cache:!1});jQuery.support.cors=!0;jQuery.getJSON(l,function(l){oa();Zb(a,l,d);if(c)r(!1)||X(a,e);else if(-1!=b){l=-1;for(var g=p.length,f=0;f<g;f++)if("image"==p[f].kind&&p[f].GetID()==b){l=f;break}ua(l,!0)}else X(a,e)}).fail(function(a,b,c){oa();V("Could not retrieve Picasa/Google+ data. Error: "+(b+", "+c))})}}function Zb(a,c,b){var e=0,l=p[a].GetID();c=c.feed.entry;var d=g.albumSorting;
...
b.url[a][d[g]].lastIndexOf("/")),k=k.substring(0,k.lastIndexOf("/"))+"/",b.url[a][d[g]]=k+"w"+f.settings.width[a][d[g]]+"/");return b}function $a(a,c,b,e){Qa(a);if(p[a].contentIsLoaded)X(a,e);else{var l="",d="album";0==p[a].GetID()?l=Q.url()+"?method=smugmug.albums.get&NickName="+g.userID+"&Heavy=true&APIKey="+Q.APIKey:(l=Q.url()+"?method=smugmug.images.get&NickName="+g.userID+"&Heavy=true&AlbumID="+p[a].GetID()+"&APIKey="+Q.APIKey,d="image");l+="&Callback=?";jb();jQuery.ajaxSetup({cache:!1});jQuery.support.cors=
!0;jQuery.getJSON(l,function(l){oa();if("fail"==l.stat)V("Could not retrieve SMUGMUG data (jQuery): "+l.message);else{$b(a,l,d);if(""!=g.gallery){g.displayBreadcrumb=!1;l=p.length;for(var f=0;f<l;f++)if(p[f].title.toUpperCase()==g.gallery.toUpperCase()){$a(f,c,b,e);return}g.displayBreadcrumb=!0;g.gallery=""}if(c)r(!1)||X(a,e);else if(-1!=b){var h=-1;l=p.length;for(f=0;f<l;f++)if("image"==p[f].kind&&p[f].GetID()==b){h=f;break}ua(h,!0)}else X(a,e)}}).fail(function(a,b,c){oa();V("Could not retrieve SMUGMUG data (jQuery): "+
(b+", "+c))})}}function $b(a,c,b){var e=0,l=p[a].GetID();if("album"==b){var d=c.Albums;switch(g.albumSorting){case "random":d=na(d);break;case "reversed":d=d.reverse();break;case "titleAsc":d.sort(function(a,b){var c=a.title.toUpperCase(),e=b.title.toUpperCase();return c<e?-1:c>e?1:0});break;case "titleDesc":d.sort(function(a,b){var c=a.title.toUpperCase(),e=b.title.toUpperCase();return c>e?-1:c<e?1:0})}jQuery.each(c.Albums,function(a,c){var d=c.Title,f=c.id+"&AlbumKey="+c.Key,s=c.Description,h=!0;
kb(d,"noID")||(h=!1);if(h&&(d=U(d,"css/nano_gallery.png","data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==",s,"",b,"",f,l),d.imageNumber=e,d.contentLength=c.ImageCount,"auto"==m()?(d.thumbImgWidth=u(),d.thumbImgHeight=u()):"auto"==u()?(d.thumbImgWidth=m(),d.thumbImgHeight=m()):(d.thumbImgWidth=m(),d.thumbImgHeight=u()),"function"==typeof g.fnProcessData&&g.fnProcessData(d,"smugmug",c),e++,e>=Na))return!1})}else{d=c.Album.Images;switch(g.photoSorting){case "random":d=
...
break}var h=d.TinyURL;for(c=Q.thumbSizeX2;0<=c;c--)if(void 0!=d[Q.photoAvailableSizesStr[c]]){h=d[Q.photoAvailableSizesStr[c]];break}0==e&&(p[a].thumbsrc=s);var k=d.Key,r=d.ThumbURL;for(c=Q.photoSize;0<=c;c--)if(void 0!=d[Q.photoAvailableSizesStr[c]]){r=d[Q.photoAvailableSizesStr[c]];break}f=U(f,s,r,"","",b,"",k,l);f.imageNumber=e;"auto"==u()&&(f.thumbImgWidth=m());"auto"==m()&&(f.thumbImgHeight=u());"function"==typeof g.fnProcessData&&g.fnProcessData(f,"smugmug",d);f.thumbX2src=h;e++;if(e>=Oa)return!1})}p[a].contentIsLoaded=
!0;p[a].contentLength=e}function U(a,c,b,e,l,d,g,f,h){a=new ac(a,f);a.thumbsrc=c;a.src=b;a.description=e;a.destinationURL=l;a.kind=d;a.albumID=h;a.tags=0==g.length?null:g.split(" ");p.push(a);return a}function kb(a,c){var b=a.toUpperCase();if(null!==Fa)for(var e=0;e<Fa.length;e++){if(b==Fa[e].toUpperCase()||c==Fa[e])return!0}else{var d=!1;if(null!==La){for(e=0;e<La.length;e++)-1!==b.indexOf(La[e])&&(d=!0);if(!d)return!1}if(null!==Ka)for(e=0;e<Ka.length;e++)if(-1!==b.indexOf(Ka[e]))return!1;return!0}}
function X(a,c){"display"==g.lazyBuild?va(d.conTnParent,g.lazyBuildTreshold)?lb(a,c):(Sa=a,Fb=c):lb(a,c)}function lb(a,c){g.lazyBuild="none";Pa=Sa=-1;Y&&Aa(!1);if(a!=hb){if(g.locationHash&&c){var b="nanogallery/"+ga+"/"+p[a].GetID();sa="#"+b;top.location.hash=b}hb=p[a].GetID();Qa(a);b=0;0<p[a].paginationLastPage&&p[a].paginationLastWidth==d.conTnParent.width()&&(b=p[a].paginationLastPage);wa(a,b)}}function Gb(a){var c="folder";0==a&&(c="folderHome");c=jQuery('<div class="'+c+' oneFolder">'+p[a].title+
"</div>").appendTo(d.conBC);jQuery(c).data("albumIdx",a);c.click(function(){var a=jQuery(this).data("albumIdx");jQuery(this).nextAll().remove();ta(a,!1,-1,!0)})}function Hb(a){var c=jQuery('<div class="separator"></div>').appendTo(d.conBC);jQuery(c).data("albumIdx",a);c.click(function(){var a=jQuery(this).data("albumIdx");jQuery(this).nextAll().remove();jQuery(this).remove();ta(a,!1,-1,!0)})}function Qa(a){var c=!1;if(1==g.displayBreadcrumb){0==d.conBC.children().length&&d.conNavBCon.css({opacity:0,
"max-height":"0px"});c=!0;d.conBC.children().remove();Gb(0);if(0!=a){var b=p.length,e=[];for(e.push(a);0!=p[a].albumID;)for(i=1;i<b;i++)if(p[i].GetID()==p[a].albumID){a=i;e.push(a);break}Hb(0);for(i=e.length-1;0<=i;i--)0<i&&Hb(e[i-1]),Gb(e[i])}b=d.conBC.children().length;0==b?(G="l1",g.breadcrumbAutoHideTopLevel&&(d.conNavBCon.css({opacity:0,"max-height":"0px"}),c=!1)):(G=1==b?"l1":"lN",1==b&&g.breadcrumbAutoHideTopLevel?d.conNavBCon.animate({opacity:"0","max-height":"0px"}):d.conNavBCon.animate({opacity:"1",
"max-height":"50px"}))}g.useTags&&(c=!0,null==Ib&&(Ib=jQuery('<div class="nanoGalleryTags"></div>').appendTo(d.conNavB)));g.galleryFullpageButton&&(c=!0);!Jb&&c&&(Jb=!0,d.conNavBCon.show())}function jb(){d.conLoadingB.css({visibility:"visible"})}function oa(){d.conLoadingB.css({visibility:"hidden"})}function ta(a,c,b,e){switch(g.kind){case "":X(a,e);break;case "flickr":yb(a,c,b,e);break;case "smugmug":$a(a,c,b,e);break;default:zb(a,c,b,e)}}function Ja(){"auto"==u()?bc():"auto"==m()?cc():dc();mb();
if(g.galleryToolbarWidthAligned&&void 0!==d.conNavBCon){var a=d.conTn.outerWidth(!0);d.conNavBCon.width();d.conNavBCon.width(a)}}function bc(){var a=d.conTnParent.width(),c=0,b=0,e=0,l=[],f=ib(),h=0,k=g.thumbnailGutterHeight,r=I(),m=d.conTn.find(".nanoGalleryThumbnailContainer");"justified"==g.thumbnailAlignment?(f=Math.min(f,m.length),h=1==f?0:(a-f*r)/(f-1)):h=g.thumbnailGutterWidth;var z=0;m.each(function(){var a=jQuery(this),d=a.data("index");if(void 0!==d){"onBottom"==g.thumbnailLabel.position&&
nb(a,p[d]);var r=0,m=0;if(0==b)r=c*(I()+h),l[c]=p[d].thumbFullHeight+k,c++,z++,c>=f&&(c=0,b++);else{var v=0,r=l[0];for(i=1;i<f;i++)if(l[i]+5<r){v=i;break}m=l[v];r=v*(I()+h);l[v]=m+p[d].thumbFullHeight+k}a.css({top:m,left:r});ob(a,p[d],e);e++}});a=l.length*(r+h)-h;r=l[0];for(i=1;i<z;i++)r=Math.max(r,l[i]);d.conTn.width(a).height(r)}function cc(){var a=d.conTnParent.width(),c=0,b=0,e=0,l=[],s=0,h=[],k=!1,r=0,m=0,z=0,v=0,O=g.thumbnailGutterWidth,w=g.thumbnailGutterHeight,x=0,q=0,y=!1,t=!1,A=d.conTn.find(".nanoGalleryThumbnailContainer");
A.each(function(){var b=jQuery(this).data("index");if(void 0!==b&&0<p[b].thumbImg().width){var e=p[b],d=Math.floor(e.thumbImg().width/e.thumbImg().height*u())+f.borderWidth+f.imgcBorderWidth;g.thumbnailFeatured&&0==r&&(z=d*=2);k&&(k=!1,s++,c=0,t=y=!1,1==s&&0<z&&(c=z,z=0));e.thumbImg().height>e.thumbImg().width?y=!0:t=!0;c+d+O<a?(c+=d+O,h[s]=u(),e=Math.max(y?x:0,t?q:0),g.thumbnailAdjustLastRowHeight&&0<e&&(h[s]=Math.min(h[s],e)),l[s]=b):(c+=d,e=Math.floor(u()*a/c),h[s]=e,y&&(x=Math.max(x,e)),t&&(q=
Math.max(q,e)),l[s]=b,k=!0);r++}});r=b=e=s=0;A.each(function(){var a=jQuery(this),c=a.data("index");if(void 0!==c&&0<p[c].thumbImg().width){var d=p[c],k=Math.floor(d.thumbImg().width/d.thumbImg().height*h[s]);0==r&&g.thumbnailFeatured&&(k*=2,m=1==h.length?2*parseInt(h[0]):parseInt(h[0])+parseInt(h[1])+f.borderHeight+f.imgcBorderHeight);var z=0;0==r&&g.thumbnailFeatured?(z=m,v=k+f.borderWidth+f.imgcBorderWidth,d.customData.featured=!0,a.find("img").attr("src",d.thumbX2src)):z=h[s];z=parseInt(z);k=
parseInt(k);a.width(k+f.imgcBorderWidth).height(z+f.imgcBorderHeight+f.labelHeight);a.find(".imgContainer").height(z).width(k);a.find("img").css({"max-height":z+2,"max-width":k+2});a.find(".subcontainer").width(k+f.imgcBorderWidth).height(z+f.imgcBorderHeight+f.labelHeight);a.css({top:e,left:b});d.thumbFullWidth=k+f.borderWidth+f.imgcBorderWidth;d.thumbFullHeight=z+f.borderHeight+f.imgcBorderHeight+f.labelHeight;pb(a);ob(a,d,r);b+=k+f.borderWidth+f.imgcBorderWidth+O;c==l[s]&&(e+=h[s]+f.labelHeight+
w+f.imgcBorderHeight+f.borderHeight,s++,b=0,1==s&&0<v&&(b=v,v=0))}r++});0<s&&(e-=w);m=m+ea()+f.labelHeight;d.conTn.width(a).height(e>m?e:m)}function ib(){var a=m()+f.borderWidth+f.imgcBorderWidth,c=d.conTnParent.width(),b=0,b="justified"==g.thumbnailAlignment?Math.floor(c/a):Math.floor((c+g.thumbnailGutterWidth)/(a+g.thumbnailGutterWidth));0<g.maxItemsPerLine&&b>g.maxItemsPerLine&&(b=g.maxItemsPerLine);1>b&&(b=1);return b}function dc(){var a=0,c=0,b=0,e=g.thumbnailGutterHeight,l=d.conTnParent.width(),
f=ib(),h=0,k=0,r=0,z=[],m=0;if(0<T&&0<I()&&f!=ja)ja=f,l=d.conPagin.data("galleryIdx"),wa(l,0);else{var v=d.conTn.find(".nanoGalleryThumbnailContainer"),O=v.length;"justified"==g.thumbnailAlignment?(f=Math.min(f,O),b=1==f?0:(l-f*I())/(f-1)):b=g.thumbnailGutterWidth;v.each(function(){var d=jQuery(this),l=d.data("index");void 0!==l&&(0==c?(a=m*(I()+b),r=z[m]=a):(a=z[m],k=c),d.css({top:c,left:a}),ob(d,p[l],h),m++,m>=f&&(m=0,c+=ea()+e),h++)});d.conTn.width(r+I()).height(k+ea())}}function ob(a,c,b){0==
a.css("opacity")&&(a.removeClass("nanogalleryHideElement"),g.thumbnailDisplayTransition?"function"==typeof g.fnThumbnailDisplayEffect?g.fnThumbnailDisplayEffect(a,c,0):a.delay(b*f.displayInterval).fadeTo(150,1):a.css({opacity:1}))}function mb(){var a=d.conTn.find(".nanoGalleryThumbnailContainer").filter(function(){return Kb(jQuery(this),f.lazyLoadTreshold)});jQuery(a).each(function(){var a=jQuery(this).find("img");if("data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw=="==
jQuery(a).attr("src")){var b=jQuery(this).data("index");jQuery(a).attr("src","");jQuery(a).attr("src",p[b].thumbImg().src)}})}function ec(a,c){if(void 0!=d.conPagin)if(d.conPagin.children().remove(),"auto"==f.settings.height[G][H]||"auto"==f.settings.width[G][H])d.conPagin.hide();else{d.conPagin.show();d.conPagin.data("galleryIdx",a);d.conPagin.data("currentPageNumber",c);var b=0,e=0;if(0<c){var l=jQuery('<div class="paginationPrev">'+R.paginationPrevious+"</div>").appendTo(d.conPagin),e=e+jQuery(l).outerWidth(!0);
l.click(function(a){Ab()})}l=0;0<T&&"auto"!=f.settings.height[G][H]&&"auto"!=f.settings.width[G][H]&&(b=Math.ceil(p[a].contentLength/(T*ja)));5<=c?(l=c-5,b>c+6&&(b=c+6)):10<b&&(b=10);if(1==b)d.conPagin.hide();else{for(;l<b;l++){var g="";l==c&&(g=" currentPage");g=jQuery('<div class="paginationItem'+g+'">'+(l+1)+"</div>").appendTo(d.conPagin);g.data("pageNumber",l);e+=g.outerWidth(!0);g.click(function(a){a=d.conPagin.data("galleryIdx");var b=jQuery(this).data("pageNumber");va(d.base,0)||$("html, body").animate({scrollTop:d.base.offset().top},
200);wa(a,b)})}c+1<b&&(b=jQuery('<div class="paginationNext">'+R.paginationNext+"</div>").appendTo(d.conPagin),e+=b.outerWidth(!0),b.click(function(a){Bb()}));d.conPagin.width(e)}}}function Bb(){var a=d.conPagin.data("galleryIdx"),c=0;0<T&&(c=p[a].contentLength/(T*ja));n2=Math.ceil(c);c=d.conPagin.data("currentPageNumber");c<n2-1?c++:c=0;va(d.base,0)||$("html, body").animate({scrollTop:d.base.offset().top},200);wa(a,c)}function Ab(){var a=d.conPagin.data("galleryIdx"),c=0;0<T&&(c=p[a].contentLength/
(T*ja));n2=Math.ceil(c);c=d.conPagin.data("currentPageNumber");0<c?c--:c=n2-1;va(d.base,0)||$("html, body").animate({scrollTop:d.base.offset().top},200);wa(a,c)}function wa(a,c){Ta=-1;d.conTn.parent().animate({opacity:0},100).promise().done(function(){d.conTn.off().empty();for(var b=p.length,e=0;e<b;e++)p[e].hovered=!1;d.conTnParent.css({left:0,opacity:1});jQuery(d.conTn[0]).css({left:0});fc(a,c,gc)})}function fc(a,c,b){if(-1!=a&&void 0!=p[a]){p[a].paginationLastPage=c;p[a].paginationLastWidth=d.conTnParent.width();
var e=p.length,l=0,h=0,k=0;0<T&&"auto"!=f.settings.height[G][H]&&"auto"!=f.settings.width[G][H]&&(k=c*T*ja);oa();var r=!1,m=!1,z=0;(function(){for(var v=0;100>v;v++){if(z>=e){b(a,c);return}var O=p[z];if(O.albumID==p[a].GetID()){h++;if(0<T&&"auto"!=f.settings.height[G][H]&&"auto"!=f.settings.width[G][H]&&l+1>T*ja){b(a,c);return}if(h>k){l++;var w=Cb(O,z,0,!1);nb(w,O);$p=w.detach();$p.css({opacity:0});$p.appendTo(d.conTn);g.thumbnailLazyLoad&&!r&&(Kb(w,f.lazyLoadTreshold)?(w.find("img").attr("src",""),
w.find("img").attr("src",O.thumbImg().src),m=!0):m&&(r=!0));Lb(w);pb(w)}}z++}z<e?setTimeout(arguments.callee,0):b(a,c)})()}}function gc(a,c){Ja();ec(a,c);Ta=a}function Cb(a,c,b,e){var l=[],f=0,h="",k=" nanogalleryHideElement";g.thumbnailLazyLoad&&"auto"==m()&&(h="top:0px;left:0px;",k="");l[f++]='<div class="nanoGalleryThumbnailContainer'+k+'" style="display:block,opacity:'+b+";"+h+'" ><div class="subcontainer" style="display:block;">';var h="",h=g.thumbnailLazyLoad?"data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==":
a.thumbImg().src,k=hc(a),r=ic(a);b=!1;"auto"==u()?(l[f++]='<div class="imgContainer" style="width:'+m()+'px;"><img class="image" src='+h+' alt=" " style="max-width:'+m()+'px;"></div>',0==p[c].thumbImg().height&&(b=!0)):"auto"==m()?(l[f++]='<div class="imgContainer" style="height:'+u()+'px;"><img class="image" src='+h+' alt=" " style="max-height:'+u()+'px;" ></div>',0==p[c].thumbImg().width&&(b=!0)):l[f++]='<div class="imgContainer" style="width:'+m()+"px;height:"+u()+'px;"><img class="image" src='+
h+' alt=" " style="max-width:'+m()+"px;max-height:"+u()+'px;" ></div>';if("album"==a.kind){if(1==g.thumbnailLabel.display){if(0<a.contentLength)switch(g.thumbnailLabel.itemsCount){case "title":k+=" "+R.thumbnailLabelItemsCountPart1+a.contentLength+R.thumbnailLabelItemsCountPart2;break;case "description":r+=" "+R.thumbnailLabelItemsCountPart1+a.contentLength+R.thumbnailLabelItemsCountPart2}l[f++]='<div class="labelImage" style="width:'+m()+'px;"><div class="labelFolderTitle labelTitle" >'+k+'</div><div class="labelDescription" >'+
r+"</div></div>"}}else 1==g.thumbnailLabel.display&&(e&&0==r.length&&"onBottom"==g.thumbnailLabel.position&&(r="&nbsp;"),l[f++]='<div class="labelImage" style="width:'+m()+'px;"><div class="labelImageTitle labelTitle" >'+k+'</div><div class="labelDescription" >'+r+"</div></div>");l[f++]="</div></div>";e=jQuery(l.join("")).appendTo(d.conTnHid);a.$elt=e;e.data("index",c);e.find("img").data("index",c);jc(e,a);if(b)ngimagesLoaded(e).on("always",function(a){var b=p[jQuery(a.images[0].img).data("index")];
if(void 0!=b&&"data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw=="!=jQuery(a.images[0].img).attr("src")){var c=!1;b.thumbImg().height!=a.images[0].img.naturalHeight&&(b.thumbSetImgHeight(a.images[0].img.naturalHeight),b.thumbSetImgWidth(a.images[0].img.naturalWidth),c=!0);b.thumbImg().width!=a.images[0].img.naturalWidth&&(b.thumbSetImgHeight(a.images[0].img.naturalHeight),b.thumbSetImgWidth(a.images[0].img.naturalWidth),c=!0);c&&(nb(b.$elt,b),pb(b.$elt),
Ja())}});return e}function hc(a){a=a.title;if(1==g.thumbnailLabel.display){if(void 0===a||0==a.length)a="&nbsp;";""!=R.thumbnailImageTitle&&(a=R.thumbnailImageTitle);3<g.thumbnailLabel.titleMaxLength&&a.length>g.thumbnailLabel.titleMaxLength&&(a=a.substring(0,g.thumbnailLabel.titleMaxLength)+"...")}return a}function ic(a){var c="";1==g.thumbnailLabel.displayDescription&&(c="album"==a.kind?""!=R.thumbnailImageDescription?R.thumbnailAlbumDescription:a.description:""!=R.thumbnailImageDescription?R.thumbnailImageDescription:
a.description,3<g.thumbnailLabel.descriptionMaxLength&&c.length>g.thumbnailLabel.descriptionMaxLength&&(c=c.substring(0,g.thumbnailLabel.descriptionMaxLength)+"..."));return c}function nb(a,c){if("auto"==u()){if(0<c.thumbImg().height){var b=c.thumbImg().height/c.thumbImg().width;a.find(".imgContainer").height(m()*b);"onBottom"==g.thumbnailLabel.position?(c.thumbLabelHeight=a.find(".labelImage").outerHeight(!0),c.thumbFullHeight=m()*b+c.thumbLabelHeight+f.borderHeight+f.imgcBorderHeight,a.width(I()-
f.borderWidth).height(c.thumbFullHeight-f.borderHeight),a.find(".labelImage").css({position:"absolute",top:"",bottom:"0px"})):(c.thumbFullHeight=m()*b+c.thumbLabelHeight+f.borderHeight+f.imgcBorderHeight,a.width(I()-f.borderWidth).height(c.thumbFullHeight-f.borderHeight))}c.thumbFullWidth=I();a.find(".subcontainer").width(I()-f.borderWidth).height(c.thumbFullHeight-f.borderHeight)}else"auto"!=m()&&(c.thumbFullHeight=ea(),c.thumbFullWidth=I(),a.width(c.thumbFullWidth-f.borderWidth).height(c.thumbFullHeight-
f.borderHeight),a.find(".subcontainer").width(c.thumbFullWidth-f.borderWidth).height(c.thumbFullHeight-f.borderHeight))}function jc(a,c){if("function"==typeof g.fnThumbnailInit)g.fnThumbnailInit(a,c,t());else switch(g.thumbnailLabel.position){case "onBottom":a.find(".labelImage").css({top:0,position:"relative",left:0,right:0});"auto"==u()?(a.find(".labelImageTitle").css({"white-space":"normal"}),a.find(".labelFolderTitle").css({"white-space":"normal"}),a.find(".labelDescription").css({"white-space":"normal"})):
...
bottom:"50%"});a.find(".labelDescription").css({left:0,right:0,position:"absolute",top:"50%"});break;default:g.thumbnailLabel.position="overImageOnBottom",a.find(".labelImage").css({bottom:0,left:0,right:0})}}function eb(a){void 0!=a&&(aa=null,void 0!==p[a].destinationURL&&0<p[a].destinationURL.length&&gb?window.location=p[a].destinationURL:(ma=!1,"album"==p[a].kind?ta(a,!1,-1,!0):ua(a,!1)))}function Ea(){for(var a=p.length,c=0;c<a;c++)p[c].hovered&&db(p[c].$elt)}function Lb(a){var c=a.data("index");
if(void 0!=c){var b=p[c];"function"==typeof g.fnThumbnailHoverInit&&g.fnThumbnailHoverInit(a,b,t());for(var e in b.eltTransform)delete b.eltTransform[e];for(j=0;j<B.length;j++)switch(B[j].name){case "imageSplit4":e=a.find(".subcontainer");var c=a.find(".labelImage"),l=a.find(".imgContainer");a.find(".imgContainer").css({position:"absolute"});e.css({overflow:"hidden",position:"relative",width:"100%",height:"100%"});e.prepend(l.clone());e.prepend(a.find(".imgContainer").clone());l=a.find(".imgContainer");
...
e[0].style[N+"Origin"]="100% 100%";A(b,"labelImage0",e).rotateZ=-90;x(b,"labelImage0");e=a.find(".imgContainer");e[0].style[N+"Origin"]="100% 100%";A(b,"imgContainer0",e);x(b,"imgContainer0");break;case "rotateCornerBR":a.css({overflow:"hidden"});e=a.find(".labelImage");e.css({opacity:1});e[0].style[N+"Origin"]="0% 100%";A(b,"labelImage0",e).rotateZ=90;x(b,"labelImage0");e=a.find(".imgContainer");e[0].style[N+"Origin"]="0 100%";A(b,"imgContainer0",e);x(b,"imgContainer0");break;case "imageRotateCornerBL":e=
a.find(".imgContainer");M(a,e);a.css({overflow:"hidden"});a.find(".labelImage").css({opacity:1});e[0].style[N+"Origin"]="bottom right";A(b,"imgContainer0",e);x(b,"imgContainer0");break;case "imageRotateCornerBR":e=a.find(".imgContainer");M(a,e);a.css({overflow:"hidden"});a.find(".labelImage").css({opacity:1});e[0].style[N+"Origin"]="0 100%";A(b,"imgContainer0",e);x(b,"imgContainer0");break;case "slideUp":a.css({overflow:"hidden"});e=a.find(".labelImage");e.css({opacity:1,top:0});A(b,"labelImage0",
...
else a.delay(B[c].delayBack)[D](b,{duration:B[c].durationBack,easing:B[c].easingBack,queue:!1});else if("transition"==D)a[D](b,B[c].durationBack,B[c].easingBack);else a[D](b,{duration:B[c].durationBack,easing:B[c].easingBack,queue:!1})}function db(a){if(!Y){var c=a.data("index");if(void 0!=c){"velocity"==D?a.find("*").velocity("stop",!0):a.find("*").filter(":animated").stop(!0,!1);var b=p[c];b.hovered=!1;var e="animate"==D?1:100;"function"==typeof g.fnThumbnailHoverOut&&g.fnThumbnailHoverOut(a,b,
...
case "imageExplode":for(var v=a.find(".imgContainer"),c=Math.sqrt(v.length),O=0,f=0;f<c;f++)for(h=0;h<c;h++)y(v.eq(O++),j,{top:0,left:0,scale:1,opacity:1});break;case "imageFlipHorizontal":y(a.find(".imgContainer"),j,{rotateX:0},b,"imgContainer0");y(a.find(".labelImage"),j,{rotateX:180},b,"labelImage0");break;case "imageFlipVertical":y(a.find(".imgContainer"),j,{rotateY:0},b,"imgContainer0"),y(a.find(".labelImage"),j,{rotateY:180},b,"labelImage0")}}catch(w){V("error on hoverOut "+w.message)}}}}function ua(a){if("fancybox"==
g.viewer){var c=[],b=0;c[b]={};c[b].href=p[a].responsiveURL();c[b].title=p[a].title;for(var e=p.length,d=a+1;d<e;d++)"image"==p[d].kind&&p[d].albumID==p[a].albumID&&(b++,c[b]={},c[b].href=p[d].responsiveURL(),c[b].title=p[d].title);for(d=0;d<a;d++)"image"==p[d].kind&&p[d].albumID==p[a].albumID&&(b++,c[b]={},c[b].href=p[d].responsiveURL(),c[b].title=p[d].title);jQuery.fancybox(c,{autoPlay:!1,nextEffect:"fade",prevEffect:"fade",scrolling:"no",helpers:{buttons:{position:"bottom"}}})}else Y?Wa(a,""):
mc(a)}function mc(a){jQuery("body").css({overflow:"hidden"});d.conVwCon=jQuery('<div  class="nanoGalleryViewerContainer" style="visibility:visible"></div>').appendTo("body");d.conVwCon.addClass("nanogallery_theme_"+g.theme);nc(d.conVwCon);d.conVw=jQuery('<div  id="nanoGalleryViewer" class="nanoGalleryViewer" style="visibility:visible" itemscope itemtype="http://schema.org/ImageObject"></div>').appendTo(d.conVwCon);var c;c=""+('<img class="image" src="'+p[a].responsiveURL()+'" alt=" " style="visibility:visible;opacity:0;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;zoom:1;" itemprop="contentURL">');
...
Ma))}function oc(a){function c(a){var b={};a.targetTouches?(b.x=a.targetTouches[0].clientX,b.y=a.targetTouches[0].clientY):(b.x=a.clientX,b.y=a.clientY);return b}function b(){e&&(Qb(f-(d.x-g.x)),e=!1)}var e=!1,d=null,g=null,f=0;this.handleGestureStart=function(a){Y&&(a.preventDefault(),a.touches&&1<a.touches.length||(d=c(a),window.navigator.msPointerEnabled?(document.addEventListener("MSPointerMove",this.handleGestureMove,!0),document.addEventListener("MSPointerUp",this.handleGestureEnd,!0)):(document.addEventListener("touchmove",
this.handleGestureMove,!0),document.addEventListener("touchend",this.handleGestureEnd,!0),document.addEventListener("touchcancel",this.handleGestureEnd,!0),document.addEventListener("mousemove",this.handleGestureMove,!0),document.addEventListener("mouseup",this.handleGestureEnd,!0))))}.bind(this);this.handleGestureMove=function(a){a.preventDefault();g=c(a);e||(e=!0,window.requestAnimFrame(b))}.bind(this);this.handleGestureEnd=function(a){a.preventDefault();a.touches&&0<a.touches.length||(e=!1,gb=
$(event.target).hasClass("labelTitle"),window.navigator.msPointerEnabled?(document.removeEventListener("MSPointerMove",this.handleGestureMove,!0),document.removeEventListener("MSPointerUp",this.handleGestureEnd,!0)):(document.removeEventListener("touchmove",this.handleGestureMove,!0),document.removeEventListener("touchend",this.handleGestureEnd,!0),document.removeEventListener("touchcancel",this.handleGestureEnd,!0),document.removeEventListener("mousemove",this.handleGestureMove,!0),document.removeEventListener("mouseup",
this.handleGestureEnd,!0)),null==g?(f=0,d=null):(a=d.x-g.x,f-=a,-50>a&&Ca(),50<a&&Ba(),f=0,g=d=null,50>Math.abs(a)&&Qb(f)))}.bind(this);window.navigator.msPointerEnabled?a.addEventListener("MSPointerDown",this.handleGestureStart,!0):a.addEventListener("touchstart",this.handleGestureStart,!0)}function Qb(a){Ya=a;if(null==N)d.vwImgC.css({left:a});else if(d.vwImgC[0].style[N]="translateX("+a+"px)","slide"==g.imageTransition)if(0<a){var c=P().w;d.vwImgP.css({visibility:"visible",left:0,opacity:1});d.vwImgP[0].style[N]=
...
300>(new Date).getTime()-pa)){var a=rb(Ha);Wa(a,"nextImage")}}function Ca(){if(!(Ia||300>(new Date).getTime()-pa)){ka&&ab();var a=sb(Ha);Wa(a,"previousImage")}}function Wa(a,c){pa=(new Date).getTime();Ia=!0;if(g.locationHash){var b="nanogallery/"+ga+"/"+p[a].albumID+"/"+p[a].GetID();"#"+b!=location.hash?(sa="#"+b,top.location.hash=b):sa=top.location.hash}pc(a);qa(d.vwImgC);Ha=a;if(""==c)d.vwImgC.css({opacity:0,left:0,visibility:"visible"}).attr("src","data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==").attr("src",
p[a].responsiveURL()),g.enableElevatezoom&&"function"==S(jQuery().elevateZoom)&&d.vwImgC.attr("data-zoom-image",p[a].responsiveURL()),jQuery.when(d.vwImgC.animate({opacity:1},300)).done(function(){ra(a,c)});else switch(g.imageTransition){case "fade":d.vwImgN.css({opacity:0,left:0,visibility:"visible"});jQuery.when(d.vwImgC.animate({opacity:0},5E3),d.vwImgN.animate({opacity:1},300)).done(function(){ra(a,c)});break;case "slideBETA":var e="nextImage"==c?d.vwImgN:d.vwImgP;e.css({opacity:1,left:0,visibility:"visible"});
if(null==N)jQuery.when(d.vwImgC.animate({left:("nextImage"==c?-P().w:P().w)+"px",opacity:0},500),e.animate({opacity:1},300)).done(function(){ra(a,c)});else{var f="nextImage"==c?-P().w:P().w;e[0].style[N]="translateX("+-f+"px) ";var b={v:Ya},h={v:"nextImage"==c?-P().w:P().w};jQuery(b).animate(h,{duration:500,step:function(a){d.vwImgC[0].style[N]="translateX("+a+"px)";d.vwImgC.css({opacity:1-Math.abs(a/f)});e[0].style[N]="translateX("+(-f+a)+"px) "},complete:function(){d.vwImgC[0].style[N]="";d.vwImgC.css({opacity:0});
ra(a,c)}})}break;case "slide":e="nextImage"==c?d.vwImgN:d.vwImgP;null==N?(e.css({opacity:0,left:0,visibility:"visible"}),jQuery.when(d.vwImgC.animate({left:("nextImage"==c?-P().w:P().w)+"px"},500),e.animate({opacity:1},300)).done(function(){ra(a,c)})):(e.css({opacity:1,left:0,visibility:"visible"}),f="nextImage"==c?-P().w:P().w,e[0].style[N]="translateX("+-f+"px) ",b={v:Ya},h={v:"nextImage"==c?-P().w:P().w},jQuery(b).animate(h,{duration:500,easing:"linear",step:function(a){d.vwImgC[0].style[N]="translateX("+
a+"px)";e[0].style[N]="translateX("+(-f+a)+"px) "},complete:function(){d.vwImgC[0].style[N]="";ra(a,c)}}));break;default:f=P().w+"px",e=d.vwImgP,"nextImage"==c&&(f="-"+f,e=d.vwImgN),e.css({opacity:0,left:0,visibility:"visible"}),jQuery.when(d.vwImgC.animate({left:f,opacity:0},500),e.animate({opacity:1},300)).done(function(){ra(a,c)})}Y=!0}function ra(a,c){Ya=0;d.vwImgC.off("click");d.vwImgC.removeClass("imgCurrent");var b=d.vwImgC;switch(c){case "nextImage":d.vwImgC=d.vwImgN;d.vwImgN=b;break;case "previousImage":d.vwImgC=
...
d.conVwTb.find(".description").html("");for(var c=0,b=p.length,e=0;e<b;e++)p[e].albumID==p[a].albumID&&"image"==p[e].kind&&c++;0<c&&d.conVwTb.find(".pageCounter").html(p[a].imageNumber+1+"/"+c)}function Aa(a){Ia&&d.vwContent.find("*").stop(!0,!0);Y&&(tb=null,window.clearInterval(ub),ka&&(window.clearInterval(za),ka=!1),Za&&Pb(),Y=!1,d.conVwCon.off().remove(),d.base.hasClass("fullpage")||jQuery("body").css({overflow:"inherit"}),-1!=Pa?X(Pa,!0):(g.locationHash&&a&&(a="nanogallery/"+ga+"/"+p[Ha].albumID,
...
"."+c+".fullpage { background:"+g.galleryFullpageBgColor+" !important; }\n";jQuery("head").append("<style>"+e+"</style>");jQuery(a).addClass(g_colorSchemeLabel);jQuery(a).addClass(c)}function nc(a){var c=null;switch(S(g.colorSchemeViewer)){case "object":c=Sb;jQuery.extend(!0,c,g.colorSchemeViewer);g_colorSchemeLabel="nanogallery_colorschemeviewer_custom";break;case "string":switch(g.colorSchemeViewer){case "none":return;case "light":c=xc;g_colorSchemeLabel="nanogallery_colorschemeviewer_light";break;
...
this.prototype;e.prototype=new d;return e});"object"==S(jQuery.velocity)?D="velocity":"object"==S(jQuery.transit)&&(D="transition");jQuery(a).addClass("nanogallery_theme_"+g.theme);qc(a);if(g.thumbnailLabel.hideIcons){var b=".nanogallery_thumbnails_icons_off ",b=b+".nanoGalleryContainer .nanoGalleryThumbnailContainer .labelImageTitle:before { display:none !important; }\n"+(b+".nanoGalleryContainer .nanoGalleryThumbnailContainer .labelFolderTitle:before { display:none !important; }\n");jQuery("head").append("<style>"+
...
O();"loadData"!=g.lazyBuild&&J();var e=0;jQuery(window).resize(function(){e&&clearTimeout(e);Y?qa(d.vwImgC):e=setTimeout(function(){var a=ba();-1==Ta||f.settings.height[G][H]==f.settings.height[G][a]&&f.settings.width[G][H]==f.settings.width[G][a]?Ja():(H=a,wa(Ta,0))},50)});jQuery(window).on("scroll",function(){vb&&clearTimeout(vb);vb=setTimeout(function(){"loadData"==g.lazyBuild&&va(d.conTnParent,g.lazyBuildTreshold)&&(g.lazyBuild="none",J());-1!=Sa&&va(d.conTnParent,g.lazyBuildTreshold)&&lb(Sa,
...
(function(t,K){function J(h,k,r){var m=u[k.type]||{};if(null==h)return r||!k.def?null:k.def;h=m.floor?~~h:parseFloat(h);return isNaN(h)?k.def:m.mod?(h+m.mod)%m.mod:0>h?0:m.max<h?m.max:h}function C(h){var z=k(),r=z._rgba=[];h=h.toLowerCase();v(q,function(k,v){var q,u=v.re.exec(h);q=u&&v.parse(u);u=v.space||"rgba";if(q)return q=z[u](q),z[m[u].cache]=q[m[u].cache],r=z._rgba=q._rgba,!1});return r.length?("0,0,0,0"===r.join()&&t.extend(r,ba.transparent),z):ba[h]}function W(h,k,r){r=(r+1)%1;return 1>6*
...
hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},u={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},I=k.support={},ea=t("<p>")[0],ba,v=t.each;ea.style.cssText="background-color:rgba(1,1,1,.5)";I.rgba=-1<ea.style.backgroundColor.indexOf("rgba");v(m,function(h,k){k.cache="_"+h;k.props.alpha={idx:3,type:"percent",def:1}});k.fn=t.extend(k.prototype,{parse:function(h,z,r,q){if(h===K)return this._rgba=[null,null,null,null],
this;if(h.jquery||h.nodeType)h=t(h).css(z),z=K;var u=this,ca=t.type(h),I=this._rgba=[];z!==K&&(h=[h,z,r,q],ca="array");if("string"===ca)return this.parse(C(h)||ba._default);if("array"===ca)return v(m.rgba.props,function(k,r){I[r.idx]=J(h[r.idx],r)}),this;if("object"===ca)return h instanceof k?v(m,function(k,r){h[r.cache]&&(u[r.cache]=h[r.cache].slice())}):v(m,function(k,r){var m=r.cache;v(r.props,function(k,z){if(!u[m]&&r.to){if("alpha"===k||null==h[k])return;u[m]=r.to(u._rgba)}u[m][z.idx]=J(h[k],
z,!0)});u[m]&&0>t.inArray(null,u[m].slice(0,3))&&(u[m][3]=1,r.from&&(u._rgba=r.from(u[m])))}),this},is:function(h){var z=k(h),r=!0,q=this;v(m,function(h,k){var m,u=z[k.cache];u&&(m=q[k.cache]||k.to&&k.to(q._rgba)||[],v(k.props,function(h,k){if(null!=u[k.idx])return r=u[k.idx]===m[k.idx]}));return r});return r},_space:function(){var h=[],k=this;v(m,function(r,m){k[m.cache]&&h.push(r)});return h.pop()},transition:function(h,z){var r=k(h),q=r._space(),t=m[q],I=0===this.alpha()?k("transparent"):this,
C=I[t.cache]||t.to(I._rgba),E=C.slice(),r=r[t.cache];v(t.props,function(h,k){var m=k.idx,v=C[m],q=r[m],O=u[k.type]||{};null!==q&&(null===v?E[m]=q:(O.mod&&(q-v>O.mod/2?v+=O.mod:v-q>O.mod/2&&(v-=O.mod)),E[m]=J((q-v)*z+v,k)))});return this[q](E)},blend:function(h){if(1===this._rgba[3])return this;var m=this._rgba.slice(),r=m.pop(),v=k(h)._rgba;return k(t.map(m,function(h,k){return(1-r)*v[k]+r*h}))},toRgbaString:function(){var h="rgba(",k=t.map(this._rgba,function(h,k){return null==h?2<k?1:0:h});1===
...
k.fn;m.hsla.to=function(h){if(null==h[0]||null==h[1]||null==h[2])return[null,null,null,h[3]];var k=h[0]/255,m=h[1]/255,v=h[2]/255;h=h[3];var q=Math.max(k,m,v),u=Math.min(k,m,v),t=q-u,I=q+u,C=.5*I,I=0===t?0:.5>=C?t/I:t/(2-I);return[Math.round(u===q?0:k===q?60*(m-v)/t+360:m===q?60*(v-k)/t+120:60*(k-m)/t+240)%360,I,C,null==h?1:h]};m.hsla.from=function(h){if(null==h[0]||null==h[1]||null==h[2])return[null,null,null,h[3]];var k=h[0]/360,m=h[1],v=h[2];h=h[3];m=.5>=v?v*(1+m):v+m-v*m;v=2*v-m;return[Math.round(255*
W(v,m,k+1/3)),Math.round(255*W(v,m,k)),Math.round(255*W(v,m,k-1/3)),h]};v(m,function(h,m){var r=m.props,q=m.cache,u=m.to,I=m.from;k.fn[h]=function(h){u&&!this[q]&&(this[q]=u(this._rgba));if(h===K)return this[q].slice();var m,z=t.type(h),C="array"===z||"object"===z?h:arguments,E=this[q].slice();v(r,function(h,k){var m=C["object"===z?h:k.idx];null==m&&(m=E[k.idx]);E[k.idx]=J(m,k)});return I?(m=k(I(E)),m[q]=E,m):k(E)};v(r,function(m,r){k.fn[m]||(k.fn[m]=function(k){var v=t.type(k),q="alpha"===m?this._hsla?
"hsla":"rgba":h,z=this[q](),u=z[r.idx];if("undefined"===v)return u;"function"===v&&(k=k.call(this,u),v=t.type(k));if(null==k&&r.empty)return this;"string"===v&&(v=E.exec(k))&&(k=u+parseFloat(v[2])*("+"===v[1]?1:-1));z[r.idx]=k;return this[q](z)})})});k.hook=function(h){h=h.split(" ");v(h,function(h,m){t.cssHooks[m]={set:function(h,v){var q,u="";if("transparent"!==v&&("string"!==t.type(v)||(q=C(v)))){v=k(q||v);if(!I.rgba&&1!==v._rgba[3]){for(q="backgroundColor"===m?h.parentNode:h;(""===u||"transparent"===
u)&&q&&q.style;)try{u=t.css(q,"backgroundColor"),q=q.parentNode}catch(z){}v=v.blend(u&&"transparent"!==u?u:"_default")}v=v.toRgbaString()}try{h.style[m]=v}catch(E){}}};t.fx.step[m]=function(h){h.colorInit||(h.start=k(h.elem,m),h.end=k(h.end),h.colorInit=!0);t.cssHooks[m].set(h.elem,h.start.transition(h.end,h.pos))}})};k.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor");t.cssHooks.borderColor=
{expand:function(h){var k={};v(["Top","Right","Bottom","Left"],function(m,v){k["border"+v+"Color"]=h});return k}};ba=t.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}})(jQuery);
(function(){function t(){}function K(q,k){for(var m=q.length;m--;)if(q[m].listener===k)return m;return-1}function J(q){return function(){return this[q].apply(this,arguments)}}var C=t.prototype,W=this,E=W.ngEventEmitter;C.getListeners=function(q){var k=this._getEvents(),m,u;if("object"===typeof q)for(u in m={},k)k.hasOwnProperty(u)&&q.test(u)&&(m[u]=k[u]);else m=k[q]||(k[q]=[]);return m};C.flattenListeners=function(q){var k=[],m;for(m=0;m<q.length;m+=1)k.push(q[m].listener);return k};C.getListenersAsObject=
function(q){var k=this.getListeners(q),m;k instanceof Array&&(m={},m[q]=k);return m||k};C.addListener=function(q,k){var m=this.getListenersAsObject(q),u="object"===typeof k,t;for(t in m)m.hasOwnProperty(t)&&-1===K(m[t],k)&&m[t].push(u?k:{listener:k,once:!1});return this};C.on=J("addListener");C.addOnceListener=function(q,k){return this.addListener(q,{listener:k,once:!0})};C.once=J("addOnceListener");C.defineEvent=function(q){this.getListeners(q);return this};C.defineEvents=function(q){for(var k=0;k<
q.length;k+=1)this.defineEvent(q[k]);return this};C.removeListener=function(q,k){var m=this.getListenersAsObject(q),u,t;for(t in m)m.hasOwnProperty(t)&&(u=K(m[t],k),-1!==u&&m[t].splice(u,1));return this};C.off=J("removeListener");C.addListeners=function(q,k){return this.manipulateListeners(!1,q,k)};C.removeListeners=function(q,k){return this.manipulateListeners(!0,q,k)};C.manipulateListeners=function(q,k,m){var u,t,E=q?this.removeListener:this.addListener;q=q?this.removeListeners:this.addListeners;
if("object"!==typeof k||k instanceof RegExp)for(u=m.length;u--;)E.call(this,k,m[u]);else for(u in k)k.hasOwnProperty(u)&&(t=k[u])&&("function"===typeof t?E.call(this,u,t):q.call(this,u,t));return this};C.removeEvent=function(q){var k=typeof q,m=this._getEvents(),u;if("string"===k)delete m[q];else if("object"===k)for(u in m)m.hasOwnProperty(u)&&q.test(u)&&delete m[u];else delete this._events;return this};C.removeAllListeners=J("removeEvent");C.emitEvent=function(q,k){var m=this.getListenersAsObject(q),
u,t,E,C;for(E in m)if(m.hasOwnProperty(E))for(t=m[E].length;t--;)u=m[E][t],!0===u.once&&this.removeListener(q,u.listener),C=u.listener.apply(this,k||[]),C===this._getOnceReturnValue()&&this.removeListener(q,u.listener);return this};C.trigger=J("emitEvent");C.emit=function(q){var k=Array.prototype.slice.call(arguments,1);return this.emitEvent(q,k)};C.setOnceReturnValue=function(q){this._onceReturnValue=q;return this};C._getOnceReturnValue=function(){return this.hasOwnProperty("_onceReturnValue")?this._onceReturnValue:
!0};C._getEvents=function(){return this._events||(this._events={})};t.noConflict=function(){W.ngEventEmitter=E;return t};"function"===typeof define&&define.amd?define("ngEventEmitter/ngEventEmitter",[],function(){return t}):"object"===typeof module&&module.exports?module.exports=t:this.ngEventEmitter=t}).call(this);
(function(t){function K(E){var q=t.event;q.target=q.target||q.srcElement||E;return q}var J=document.documentElement,C=function(){};J.addEventListener?C=function(t,q,k){t.addEventListener(q,k,!1)}:J.attachEvent&&(C=function(t,q,k){t[q+k]=k.handleEvent?function(){var m=K(t);k.handleEvent.call(k,m)}:function(){var m=K(t);k.call(t,m)};t.attachEvent("on"+q,t[q+k])});var W=function(){};J.removeEventListener?W=function(t,q,k){t.removeEventListener(q,k,!1)}:J.detachEvent&&(W=function(t,q,k){t.detachEvent("on"+
q,t[q+k]);try{delete t[q+k]}catch(m){t[q+k]=void 0}});J={bind:C,unbind:W};"function"===typeof define&&define.amd?define("eventie/eventie",J):t.eventie=J})(this);
(function(t,K){"function"===typeof define&&define.amd?define(["ngEventEmitter/ngEventEmitter","eventie/eventie"],function(J,C){return K(t,J,C)}):"object"===typeof exports?module.exports=K(t,require("wolfy87-eventemitter"),require("eventie")):t.ngimagesLoaded=K(t,t.ngEventEmitter,t.eventie)})(window,function(t,K,J){function C(k,h){for(var m in h)k[m]=h[m];return k}function W(k){var h=[];if("[object Array]"===ea.call(k))h=k;else if("number"===typeof k.length)for(var m=0,r=k.length;m<r;m++)h.push(k[m]);
else h.push(k);return h}function E(k,h,q){if(!(this instanceof E))return new E(k,h);"string"===typeof k&&(k=document.querySelectorAll(k));this.elements=W(k);this.options=C({},this.options);"function"===typeof h?q=h:C(this.options,h);if(q)this.on("always",q);this.getImages();m&&(this.jqDeferred=new m.Deferred);var r=this;setTimeout(function(){r.check()})}function q(k){this.img=k}function k(k){this.src=k;ba[k]=this}var m=t.jQuery,u=t.console,I="undefined"!==typeof u,ea=Object.prototype.toString;E.prototype=
new K;E.prototype.options={};E.prototype.getImages=function(){this.images=[];for(var k=0,h=this.elements.length;k<h;k++){var m=this.elements[k];"IMG"===m.nodeName&&this.addImage(m);var r=m.nodeType;if(r&&(1===r||9===r||11===r))for(var m=m.querySelectorAll("img"),r=0,q=m.length;r<q;r++)this.addImage(m[r])}};E.prototype.addImage=function(k){k=new q(k);this.images.push(k)};E.prototype.check=function(){function k(q,v){h.options.debug&&I&&u.log("confirm",q,v);h.progress(q);m++;m===r&&h.complete();return!0}
